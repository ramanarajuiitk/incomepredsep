...
#            self.logger.log(file, "Opened %s database success fully" % DatabaseName)
#            file.close()
                ...
                with open(goodFilePath+'/'+file, "r") as f:
                    ...
                    for line in enumerate(reader):
                        ...
                        for list_ in (line[1]):
                            ...
                            #print(list_)
                            try:
                                x=str(list_.split(","))[1:-1]
                                conn.execute('INSERT INTO Good_Raw_Data values ({values})'.format(values=(x)))
                                #print('I am reading3')
